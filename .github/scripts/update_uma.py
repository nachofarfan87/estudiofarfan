#!/usr/bin/env python3
# .github/scripts/update_uma.py
"""Lee el valor del UMA del sitio del Colegio de Abogados de Jujuy y actualiza
public/honorarios/uma.json si cambió. Corre en GitHub Actions: desde un servidor no hay
...
UMA_JSON = pathlib.Path(__file__).resolve().parents[2] / "public" / "honorarios" / "uma.json"


def fetch(url):
    req = urllib.request.Request(url, headers={
        "User-Agent": "Mozilla/5.0 (compatible; EstudioFarfan-UMA-Updater/1.0)",
        "Accept": "text/html",
    })
